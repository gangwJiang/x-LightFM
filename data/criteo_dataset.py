...
class CriteoDataset(torch.utils.data.Dataset):
    ...
    def modify_commandline_options(parser):
        parser.add_argument('--dataset_path', type=str, default="/amax/home/gangwei/project/dataset/Criteo/train.txt")
        parser.add_argument('--cache_path', type=str, default="/amax/home/gangwei/project/dataset/Criteo/.criteo")
        parser.add_argument('--popular_path', type=str, default="/amax/home/gangwei/project/LightFM/data/criteo_popular.pkl")
        return parser

    def __init__(self, dataset_path=None, cache_path='/data2/home/gangwei/project/pytorch-fm/project/.criteo', rebuild_cache=False, min_threshold=10):
        self.NUM_FEATS = 39
